...
uci set system.@system[0].hostname='N1'              # 修改主机名称为OpenWrt-123
...
sed -i "s/OpenWrt /BlackBag compiled in $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" "${ZZZ_PATH}"
